...
describe ChallengeClaimsController do
  ...
  describe 'index' do
    ...
    it 'will not allow you to see someone elses claims' do
      ...
      it_redirects_to_with_error(root_path,  "You aren't allowed to see that user's claims.")
    end
  end
  ...
  describe 'show' do
    ...
    xit 'needs a collection' do
      get :show
      it_redirects_to_with_error(root_path, "What challenge did you want to work with?")
    end
  end
  ...
  describe 'create' do
    ...
    it 'on an exception gives an error and redirects' do
      ...
      post :create, params: { collection_id: collection.name, challenge_claim: {collection_id: collection.id} }
      it_redirects_to_with_error(collection_claims_path(collection, for_user: true),"We couldn't save the new claim.")
    end
  end
  ...
  describe 'destroy' do
    context 'with a claim' do
      ...
      it 'gives and error and redirects if record can not be destroyed' do
