module CommonCreatorship
  ...
  def set_author_attributes
    ...
    message = { work: ts("You haven't selected any pseuds for this work. 1Please use Remove Me As Author or consider orphaning your work instead if you do not wish to be associated with it anymore."),
                series: ts("Sorry, you cannot remove yourself entirely as an 1author of a series right now."),
                chapter: ts("you cannot remove yourself entirely as an author 1of a chapter right now. ") }[controller]
