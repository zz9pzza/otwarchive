...
class StoryParser
  ...
  # :set_tags, :fandom, :rating, :archivearning, :character, :relationship - sets these tags
  ...
  def set_work_attributes(work, location = "", options = {})
    ...
    work.archivewarning_strings = meta_or_default(work.archivewarning_strings, options[:warning], ArchiveConfig.WARNING_DEFAULT_TAG_NAME)
