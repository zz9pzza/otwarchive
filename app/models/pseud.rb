class Pseud < ActiveRecord::Base
  ...
  validates_length_of :name,
    ...
    :too_short => ts("is too short (minimum is %{min} characters)", :key => "psued", :min => NAME_LENGTH_MIN),
    :too_long => ts("is too long (maximum is %{max} characters)",:key => "psued", :max => NAME_LENGTH_MAX)
